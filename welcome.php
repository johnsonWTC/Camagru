...
echo '<div class="title-camagru"><a href="login.php"><h1 style="padding: 2px;">Camagru</h1></a></div><p><a href="login.php"><button class="logoutbtn" style="float: right; padding: 2px;" type="submit" name="logout" value="ok">logout</button></a></p>';
